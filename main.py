...
def send_message(to_user, access_token, city_name, weather, max_temperature, min_temperature, note_ch, note_en, chp):
...
chp = get_chp() 
# 公众号推送消息
send_message(user1, accessToken, city, weather, max_temperature, min_temperature, note_ch, note_en, chp)
send_message(user2, accessToken, city, weather, max_temperature, min_temperature, note_ch, note_en, chp)
